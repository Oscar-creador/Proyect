...
<div id="main-container">
	<table border="1" >
		...
		<tr>
			...
			<td><a href="editarMATERIAS.php?id=<?php echo urlencode($mostrar['id']);?>"><img src="https://i.ibb.co/KN50dsp/edicionado.jpg" alt="edicionado" border="0"></a></td>
			<td><a href="eliminarMATERIAS.php?id=<?php echo urlencode($mostrar['id']);?>"><img src="https://i.ibb.co/VB3Rhf1/DELETEXD.jpg" alt="DELETEXD" border="0"></a></a></td>
		</tr>
	<?php 
	}
	 ?>
